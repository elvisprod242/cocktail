...
export const ProductCard: React.FC<ProductCardProps> = ({ product, iconName, onAdd, currency }) => {
  ...
  return (
    ...
    >
      <div className="relative h-24 w-full overflow-hidden bg-gradient-to-br from-slate-800 to-slate-700 flex items-center justify-center group-hover:from-slate-700 group-hover:to-slate-600 transition-colors">
        <Icon className="text-bar-accent w-8 h-8 drop-shadow-lg transform group-hover:scale-110 transition-transform duration-300" />
