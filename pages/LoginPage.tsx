        ...
        {step === "SELECT" ? (
          <div className="animate-in fade-in zoom-in-95 duration-500">
            <div className="text-center mb-12">
              ...
              <h1 className="text-2xl md:text-3xl font-black text-white italic tracking-tighter mb-2 uppercase">
                BARFLOW AI
              </h1>
              ...
              {users.map((user) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className={`w-20 h-20 rounded-2xl flex items-center justify-center border-2 mb-4 transition-all group-hover:shadow-lg ${
                        user.role === UserRole.ADMIN
                          ? "bg-purple-500/10 border-purple-500/30 text-purple-400 group-hover:shadow-purple-500/20"
                          : user.role === UserRole.BARTENDER
                            ? "bg-blue-500/10 border-blue-500/30 text-blue-400 group-hover:shadow-blue-500/20"
                    ...
                    <h3 className="text-white font-black text-xl mb-2 italic">
                      {user.name}
                    </h3>
                    <span
                      className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border ${badge.color}`}
                    >
                      {badge.label}
                    </span>
                  </button>
          ...
          <div className="max-w-md mx-auto animate-in slide-in-from-bottom-10 fade-in duration-500">
            ...
            <div
              className={`bg-slate-900/80 backdrop-blur-xl border-2 p-8 rounded-[40px] shadow-3xl flex flex-col items-center transition-all ${error ? "border-red-500/50 shake" : isSuccess ? "border-green-500/50" : "border-slate-800"}`}
            >
              <div className="text-center mb-8">
                <div
                  className={`w-20 h-20 rounded-3xl flex items-center justify-center border-2 mx-auto mb-4 ${
                    selectedUser?.role === UserRole.ADMIN
                      ? "bg-purple-500/10 border-purple-500/30 text-purple-400"
                      : selectedUser?.role === UserRole.BARTENDER
                      ...
                      i < pin.length
                        ? isSuccess
                          ...
                          : error
                            ...
                            : "bg-bar-accent border-bar-accent scale-110 shadow-[0_0_15px_rgba(233,69,96,0.5)]"
                        : "border-slate-700"
                    }`}
                  />
                ))}
