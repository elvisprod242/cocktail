      ...
      <div className="max-w-3xl w-full">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400">
            Entrez les ingrédients dont vous disposez, et laissez l'IA inventer
            votre prochain cocktail signature.
          </p>
        </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden shadow-2xl animate-in slide-in-from-bottom-8 fade-in duration-500">
            ...
            <div className="p-6 md:p-8 grid gap-8">
              <div>
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {recipe.ingredients.map((ing, i) => (
                    <li
                      key={i}
                      className="flex items-center gap-2 text-slate-300 bg-slate-950/50 p-3 rounded-lg border border-slate-800/50"
                    >
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-bar-accent font-bold uppercase tracking-wider text-sm mb-4">
                    Instructions
                  </h3>
